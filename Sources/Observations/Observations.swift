...
struct HomeView: View {
    ...
    @State var suspect = Suspect(name: "Chewbacca", suspiciousness: 0)
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            GroupBox {
              ...
              //  Stepper("Suspiciousness", value: $suspect.suspiciousness, in: 0...10)
                ...
                Button {
                    ...
                    Text("BARELY SUSPICIOUS \(suspect.suspiciousness)")
                }
            }
